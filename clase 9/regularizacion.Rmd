...
`Estadisticas` es una tabla que contiene 51 variables, de las cuales 46 contienen información de muchas estadísticas de la temporada 2017-2018.

Hacemos el join por jugador y equipo. Un jugador puede ser cambiado/vendido durante la temporada. De esta manera mantenemos a los jugadores con las estadisticas correspondientes al equipo con quien acordaron el salario.
...
Observamos que la distribución varía un poco entre posiciones y hay algunos jugaroes que son outliers.
...
* Sólo tres variables tienen coeficientes significativos: **G**, **GS** y **Age**
...
* Las mismas tres variables tienen coeficientes significativos: **G**, **GS** y **Age**
...
## como ni siquiera tenemos una intuición de dónde vive lambda, este modelo por default hace CV
## y va probando con distintos lambda (el modelo solo determina el rango de prueba)
...
## sobreviven aquellas que tienen betas más baratos, las que tiene beta más chico
## como un movimiento en una unidad de esas es más importante, sobreviven a la selección del Lasso
```
...
## líneas verticales: lambda mínimo y 1SD (que es el más parsimonioso porque nos deja menos variables)
```
...
Han quedado 7 variables, todas con coeficientes positivos y el modelo explica el 63.76% de la deviance.
